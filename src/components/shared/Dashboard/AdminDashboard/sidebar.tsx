...
const links = [
  ...
  { href: "/dashboard/admin/skills", label: "Skills", icon: Sparkles },
   { href: "/dashboard/admin/education", label: "Education", icon: BookOpenCheck },
  { href: "/dashboard/admin/experience", label: "Experience", icon: FileText },
  { href: "/dashboard/admin/projects", label: "Projects", icon: BriefcaseBusiness },
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <Link href="/">
              <span className="text-2xl font-semibold">
                <span className="text-green-600 font-quicksand">Dash</span>
                Board
              </span>
            </Link>
